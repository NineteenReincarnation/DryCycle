...
/// remain independent.
///
/// The backend audits terrain in bounded batches and republishes readiness changes. This projection
/// consumes that revision; drawing the UI does not drive semantic discovery.
/// </summary>
