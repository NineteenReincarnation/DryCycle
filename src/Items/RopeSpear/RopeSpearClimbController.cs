...
internal static class RopeSpearClimbController
{
        ...
        ref float poseCycle)
    {
        ...
        // Keep the diagonal-rope movement fix: movement follows the rope's local
        // tangent, so Up/Right/diagonal input can all move along a sloped rope.
        ...
        // Exact historical mount trigger from ec86992/a7b1855: once the player has
        // physically reached the rope end, holding world-space Up attempts the
        // vanilla horizontal-beam handoff. Do not derive this from rope tangent.
