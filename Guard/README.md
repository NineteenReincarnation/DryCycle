...
- `build-safety.sh`：CI 静态 Build Safety Guard。执行 C# 语法解析、直接部署写入门控检查和核心项目的可选 UI 依赖方向检查。语法解析不等同于完整编译。
...
真实编译、启动、功能行为、存档/作者格式兼容和性能问题，应由对应的构建、测试、游戏运行或性能分析验证，不用字符串 Guard 代替。
